...
<!--<meta name="google-site-verification" content="olt_KMuJwtpSEvmeWAnUETSZTeWdVTzDcYep39YhJmU" />-->
    ...
    <link type="text/css" rel="stylesheet" href="ui-development-training.html" id="color-skins">
        ...
        <div class="container">
            <div class="header-main-wrapper">
                <div class="navbar-header">
                    ...
                    <a href="index.html"><h2 class="wt-color wt-logo" title="Web and Mobile Technologies Training Institute">WEB <div class="green">TECHIES</div><small>Learn for tomorrow...</small></h2></a>					
                    </div>
...
<div class="content">
    ...
    <div class="section section-padding">
                            ...
                            <div class="row ">
                                <div class="col-md-12">
                                    <div class="course-des">
                                        ...
                                        <div class="news-list">
                                            <div class="list-expand-title">Why User Interface Development Course?</div>
                                            <div class="row">
            ...
            <ul class="list-unstyled list-detail">
                ...
                <a href="#">Learn UI Development for Information Technology</a></li>
                <li><i class="fa fa-check-circle"></i>
                ...
                <li><i class="fa fa-check-circle"></i>
                <a href="#">Gain very good understanding of Coding principles and how to use them.</a></li>
                <li><i class="fa fa-check-circle"></i>
                                        ...
                                        <div class="course-table">
                                            <div class="outer-container">
                                                <div class="inner-container">
                                                    <p>The SURYA ITTECH UI Development Course will teach you the User Interfaces for Industrial and Product Development. In this course you will learn the principles of development,  usuability improvement skills and the Industry oriented development interfaces for present and future devices.</p>
...
<!-- Courses --> 
             ...
             <i class="fa fa-desktop"></i> UI Development Package Course - <span><em>10 Students per batch</em></span></div>
             <section class="course-content">
                <details role="Photoshop Design Course">
                    <summary>UI Development <small><i>(Beginner Level)</i></small>
                ...
                <ul class="list-unstyled list-detail">
                    ...
                    <li><i class="fa fa-check-circle"></i>Introduction of UI Development</li>
                    <li><i class="fa fa-check-circle"></i>Fundmentals of UI Development</li>
                    <li><i class="fa fa-check-circle"></i>Why UI Development</li>
                    <li><i class="fa fa-check-circle"></i>Advantage of UI Development</li>
                    <li><i class="fa fa-check-circle"></i>Creating Mockups and Prototyes</li>
                    <li><i class="fa fa-check-circle"></i>Using HTML5 Semantic Tags</li>
                    <li><i class="fa fa-check-circle"></i>Converting Existing Pages to HTML5</li>
                    <li><i class="fa fa-check-circle"></i>Inserting New HTML5 Elements in Design and Code Views</li>
...
<div class="date-time item pull-right"><a href="#"><i class="fa fa- fa-download fa-2x"></i> Download Course Content</a></div>
                ...
                <details role="Photoshop Design Course">
                    <summary>UI Development <small><i>(Advanced Level)</i></small>
                    <span class="pull-right">
                ...
                <li><i class="fa fa-check-circle"></i>Object Oriented JavaScript</li>
                <li><i class="fa fa-check-circle"></i>JavaScript Data Types</li>
                <li><i class="fa fa-check-circle"></i>JavaScript Functions & Scopes</li>
                <li><i class="fa fa-check-circle"></i>DOM (Document Object Model)</li>
                <li><i class="fa fa-check-circle"></i>JavaScript Variable Scope and Hoisting</li>
                <li><i class="fa fa-check-circle"></i>Understand JavaScript Callback Functions</li>
                <li><i class="fa fa-check-circle"></i>AngularJS Introduction</li>
                <li><i class="fa fa-check-circle"></i>AngularJS MVC Framework</li>
                <li><i class="fa fa-check-circle"></i>AngularJS Serives</li>
                <li><i class="fa fa-check-circle"></i>AngularJS, Directives, Scope Object, UI & Bootstrap</li>					
