...
<!--<meta name="google-site-verification" content="olt_KMuJwtpSEvmeWAnUETSZTeWdVTzDcYep39YhJmU" />-->
    ...
    <link type="text/css" rel="stylesheet" href="ux-designing-training.html" id="color-skins">
...
<!-- SLIDER BANNER-->
                    ...
                    <div class="search-input">
                        <div class="container">
                            <div class="search-input-wrapper">
                                <h2 class="captions white">UX Designing</h2>
                                <ol class="breadcrumb white">
                                    <li><a href="index.html" class="white">Home</a></li>
                                    <li><a href="ui-designing-training.html" class="white">Training Courses</a></li>
                                    <li class="active"><a href="#" class="white">UX Designing</a></li>
                            </ol>
                            </div>
                        </div>
                    </div>
 ...
 <div class="section section-padding">
                                ...
                                <div class="col-md-12">
                                    <div class="course-des">
                                        <blockquote>
                                                ...
                                                <div class="sub-quote">Student or professional, fresher or experienced, SURYA ITTECH helps you gain the project experience and skills required to enter the User Interface Development Industry. The IT and fast growing product industry in India needs skilled, knowledgeable and trained UI/UX Development to create innovative products.</div>
                                               
                                            </blockquote>
                                        
                                        <div class="news-list">
                                            <div class="list-expand-title">Why User Experience Designing Course? <abbr title="User Experience Designer">(UXD)</abbr></div>
                                            <div class="row">
            ...
            <ul class="list-unstyled list-detail">
                ...
                <a href="#">Learn UI / UX Designing for Information Technology</a></li>
                <li><i class="fa fa-check-circle"></i>
                ...
                <li><i class="fa fa-check-circle"></i>
                <a href="#">Gain very good understanding of Designing principles and how to use them.</a></li>
                <li><i class="fa fa-check-circle"></i>
                <a href="#">100% Job Guarantee and Industry Skill Designing Course</a></li>
            </ul>
                                                </div> 
                                        ...
                                        <div class="course-table">
                                            <div class="outer-container">
                                                <div class="inner-container">
                                                    <p>The SURYA ITTECH UX Design and Development Course will teach you the User Experience for Industrial and Innovative product concepts and bringing them to life. In this course you will learn the principles of user experience, product and branding design, creating wireframes, prototypes, interfaces for multiple devices and usuability improvement skills.</p>
...
<!-- Courses --> 
				<div class="container">
                <div class="col-md-12 col-sm-6">
             <div class="list-expand-title nospace topMar20">
             <i class="fa fa-desktop"></i> UX Designing Package Course - <span><em>10 Students per batch</em></span></div>
             <section class="course-content">
                <details role="Photoshop Design Course">
                    <summary>UX Designing <small><i>(Beginner Level)</i></small>
                    <span class="pull-right">
                    <i class="fa fa-clock-o"></i> 30 Hours - 
                    <i class="fa fa-rupee"></i>  6000</span>
                    </summary>
                ...
                <li><i class="fa fa-check-circle"></i>What UX is</li>
                <li><i class="fa fa-check-circle"></i>What UX consists of</li>
                <li><i class="fa fa-check-circle"></i>Who is involved in it and why it matters</li>
                <li><i class="fa fa-check-circle"></i>Understand the elements of user experience</li>
                <li><i class="fa fa-check-circle"></i>Wireframing & Rapid Prototypes</li>                
                <li><i class="fa fa-check-circle"></i>User Experience Design Introduction</li>
                <li><i class="fa fa-check-circle"></i>What Makes a Great User Experience?</li>
                <li><i class="fa fa-check-circle"></i>UX Design Fundamentals</li>
                <li><i class="fa fa-check-circle"></i>Understand user experience design and why it's important</li>				
                ...
                <ul class="list-unstyled list-detail">
                    ...
                    <li><i class="fa fa-check-circle"></i>Understand UX design principles and techniques</li>
                    <li><i class="fa fa-check-circle"></i>Identify business goals, and user needs</li>
                    <li><i class="fa fa-check-circle"></i>Desining User Goals & User Flows</li>
                    <li><i class="fa fa-check-circle"></i>Design process and Methods</li>
                    <li><i class="fa fa-check-circle"></i>Applying Human-centered Design</li>
                    <li><i class="fa fa-check-circle"></i>Enhancing Site Navigation and Laying Out Our Site</li>
                    <li><i class="fa fa-check-circle"></i>Understanding the Need for Structure</li>
                    <li><i class="fa fa-check-circle"></i>Wireframing -  Using Responsive Web Design</li>
                    <li><i class="fa fa-check-circle"></i>UX Design for Web and Mobile Applications</li>
...
<div class="date-time item pull-right"><a href="#"><i class="fa fa- fa-download fa-2x"></i> Download Course Content</a></div>
                ...
                <details role="Photoshop Design Course">
                    <summary>UI/UX Designing <small><i>(Advanced Level)</i></small>
                    <span class="pull-right">
                ...
                <ul class="list-unstyled list-detail">
                    ...
                    <li><i class="fa fa-check-circle"></i>Creating Landing page and Applying Interactions</li>
                    <li><i class="fa fa-check-circle"></i>Information Architecture & Navavigation</li>
                    <li><i class="fa fa-check-circle"></i>Create an effective information design</li>
                    <li><i class="fa fa-check-circle"></i>User experience in the digital age</li>
                    <li><i class="fa fa-check-circle"></i>Research and Understanding the User</li>
                    <li><i class="fa fa-check-circle"></i>Best Practices and Usability</li>
                    <li><i class="fa fa-check-circle"></i>Prototyping - Clickable Wireframes</li>
                    <li><i class="fa fa-check-circle"></i>Wireframing -  for Web and Mobile Apps</li>
                    <li><i class="fa fa-check-circle"></i>Validate and Iterate Your Prototype</li>
				...
				<div class="clearfix"></div>
             	<div class="col-md-12 col-sm-6">
                             ...
                             <section class="course-content" role="UI Design Course Content">
                                ...
                                <details>
                                	<summary>HTML5, CSS3 with JavaScript</summary>
                                    <p>Will be update soon...</p>
                                </details>
                                
                                <details>
                                	<summary>HTML5, CSS3, JS & Bootstrap</summary>
                                    <p>Will be update soon...</p>
                                </details>
                                
                                <details>
                                	<summary>HTML5, CSS3 & Bootstrap</summary>
                                    <p>Will be update soon...</p>
                                </details>
                                ...
                                <details>
                                	<summary>JavaScript(Advanced)</summary>
                                    <p>Will be update soon...</p>
                                </details>
                                
                                <details>
                                	<summary>AngularJS and JSON</summary>
                                    <p>Will be update soon...</p>
                                </details>
                                
                                <details>
                                	<summary>AngularJS, JSON & NodeJS</summary>
                                    <p>Will be update soon...</p>
                                </details>
