                        ...
                        <div class="row topMar20">
                            ...
                            <div class="col-md-5">
                                <div class="intro-content">
                                    <h3>Web Development Certification Course</h3>
                                </div>
                                <div class="intro-content" style="text-align:justify;">
                                    ...
                                    <div>
                                        ...
                                        <ul>
                                            <li><a href=""><i class="fa fa-arrow-circle-o-right"></i> Getting Started & HTML </a>
                                            </li>
                                            <li><a href=""><i class="fa fa-arrow-circle-o-right"></i> CSS</a>
                                            </li>
                                            <li><a href=""><i class="fa fa-arrow-circle-o-right"></i> Javascript</a>
                                            </li>
                                            <li><a href=""><i class="fa fa-arrow-circle-o-right"></i> JQuery</a>
                                            </li>
                                            <li><a href=""><i class="fa fa-arrow-circle-o-right"></i> Twitter Bootstrap</a>
                                            </li>
                                            <li><a href=""><i class="fa fa-arrow-circle-o-right"></i> Wordpress</a>
                                            </li>
                                            <li><a href=""><i class="fa fa-arrow-circle-o-right"></i> PHP</a>
                                            </li>
                                            <li><a href=""><i class="fa fa-arrow-circle-o-right"></i> MySQL</a>
                                            </li>
                                            <li><a href=""><i class="fa fa-arrow-circle-o-right"></i> API's</a>
                                            </li>
                                            <li><a href=""><i class="fa fa-arrow-circle-o-right"></i> Mobile Apps</a>
                                            </li>
                                            <li><a href=""><i class="fa fa-arrow-circle-o-right"></i> What's Next</a>
                                            </li>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="price-tag"><a><h2>Rs.5,500/-</h2></a><strike>Rs.15,500/-</strike>,65% off
                                </div>
                                <a><b>2 days</b> left at this price!</a>
                                <hr>                                
<!--  
                                <div class="pm-button">
                                    <a href="https://www.payumoney.com/paybypayumoney/#/377689">
                                        <img src="https://www.payumoney.com//media/images/payby_payumoney/buttons/232.png" />
                                    </a>
                                </div>
-->
<!--                                <h3>Register Now</h3>-->
                                ...
                                @endif
                                <br>
                                <form method="POST" action="/web-app-certification-course-create"role="form" class="myform">
                                {{csrf_field()}}
                                    <div class="form-group">
                                        <label for="student_name">Name on Certificate</label><span style="color:red"><b>*</b></span>
                                        <input type="name" name="student_name" id="studentname" class="form-control" placeholder="Enter name">
                                    </div>
                                     <div class="form-group">
                                        <label for="email">Email Address</label><span style="color:red"><b>*</b></span>
                                        <input type="email" name="email" id="email" class="form-control" placeholder="Enter email">
                                    </div> 
                                    <button type="submit" class="btn btn-custom btn-block" onClick="clearform();">REGISTER NOW</button>
                                </form>      
                                <br>
                    ...
                    <div class="responsive-tabs">
                        ...
                        <div>
                            <br>
                            <ul>
                                <li>Please contact our Customer Care <b><i>support@suryaittech.com</i></b>
                                </li>
