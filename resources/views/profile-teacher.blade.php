...
<!-- Mirrored from swlabs.co/edugate/profile-teacher.html by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 14 Feb 2016 04:07:56 GMT -->
<head><title>Edugate | Profile Teacher</title>
    <meta charset="utf-8">
    ...
    <link type="text/css" rel="stylesheet" href="profile-teacher.html" id="color-skins">
                        ...
                        <div class="teacher-skill-wrapper">
                            ...
                            <div class="row skill-content">
                                ...
                                <div class="col-md-6 skill-level">
                                    ...
                                    <div class="progress">
                                        <div role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" class="progress-bar skill-5"></div>
                                    </div>
                                </div>
                                <div class="col-md-6 skill-level">
                                    <div class="skill-name">creativity</div>
                                    <div class="progress">
                                        <div role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" class="progress-bar skill-6"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
