...
<!-- Mirrored from swlabs.co/edugate/news-masonry.html by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 14 Feb 2016 04:08:02 GMT -->
<head><title>Edugate | News masonry</title>
    <meta charset="utf-8">
    ...
    <link type="text/css" rel="stylesheet" href="news-masonry.html" id="color-skins">
        ...
        <div class="main-content"><!-- CONTENT-->
            <div class="content">
                <div class="section background-opacity page-title set-height-top">
                    <div class="container">
                        <div class="page-title-wrapper"><h2 class="captions">news & update</h2>
                            <ol class="breadcrumb">
                            ...
                            <div class="col-md-12">
                                <div class="news-page-wrapper news-masonry">
                                    ...
                                    <div class="gird-item">
                                        <div class="edugate-layout-3 news-gird">
                                            <div class="edugate-layout-3-wrapper">
                                                <div class="edugate-video-player">
                                                    <video src="http://www.w3schools.com/tags/movie.mp4" type="video/mp4" controls></video>
                                                </div>
                                                <div class="edugate-content"><a href="news-detail.html" class="title">Conference on Edugate</a>
                                                    ...
                                                    <div class="description">Dalmatian hello amazing the rmore flung as thanks a manta dealt to under emu.</div>
                                                    <button class="btn btn-green"><span>read more</span></button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="gird-item">
                                        <div class="edugate-layout-3 news-gird">
                                            <div class="edugate-layout-3-wrapper">
                                                <div class="edugate-audio-player">
                                                    <audio src="http://www.w3schools.com/tags/horse.mp3" type="audio/mp3" controls></audio>
                                                </div>
                                                <div class="edugate-content"><a href="news-detail.html" class="title">E-Learn 2015 - World Conference on Edugate Website</a>
                                                    ...
                                                    <div class="description">Dalmatian hello amazing the rmore flung as thanks a manta dealt to under emu some the and one save and spitefully less.</div>
                                                    <button class="btn btn-green"><span>read more</span></button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="edugate-layout-3 news-gird">
                                            <div class="edugate-layout-3-wrapper">
                                                <div class="edugate-image">
                                                    <div class="news-gird-slider"><img src="assets/images/news/news-1.jpg" alt="" class="img-responsive"/><img src="assets/images/news/news-2.jpg" alt="" class="img-responsive"/></div>
                                                </div>
                                                <div class="edugate-content"><a href="news-detail.html" class="title">E-Learn 2015 - World Conference on Edugate Website</a>
                                            ...
                                            <div class="edugate-layout-3-wrapper">
                                                <div class="edugate-content">
                                                    <blockquote class="note-title">
                                                        <div class="main-quote">Video courses to build new skills from start finish of couurses website.</div>
                                                        <div class="author-quote">Amber Ivy <span>&nbsp;(Grancie Company)</span></div>
                                                    </blockquote>
                                                    <div class="description">Dalmatian hello amazing the rmore flung as thanks a manta dealt to under emu some the and one baldbe dear sobbingly save and spitefully less.</div>
                                                    <button class="btn btn-green"><span>read more</span></button>
                                                </div>
...
<script src="assets/libs/media-element/build/mediaelement-and-player.min.js"></script>
<script src="assets/libs/isotope/isotope.pkgd.min.js"></script>
<script src="assets/libs/isotope/fit-columns.js"></script>
<script src="assets/js/pages/news-masonry.js"></script>
</body>

<!-- Mirrored from swlabs.co/edugate/news-masonry.html by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 14 Feb 2016 04:08:04 GMT -->
</html>