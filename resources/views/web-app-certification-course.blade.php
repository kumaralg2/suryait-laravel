...
<!--                                <h3>Register Now</h3>-->
                                ...
                                <form role="form">
                                    <div class="form-group">
                                        <label for="name">Name on Certificate</label><span style="color:red"><b>*</b></span>
                                        <input type="name" class="form-control" placeholder="Enter name">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Email Address</label><span style="color:red"><b>*</b></span>
                                        <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                                    </div>
                                    <button type="submit" class="btn btn-custom btn-block">REGISTER NOW</button>
                                </form>                    
                            </div>
                        </div>
                    </div>
