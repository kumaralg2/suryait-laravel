...
<!-- Mirrored from swlabs.co/edugate/news-detail.html by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 14 Feb 2016 04:08:04 GMT -->
<head><title>Edugate | News Detail</title>
    <meta charset="utf-8">
    ...
    <link type="text/css" rel="stylesheet" href="news-detail.html" id="color-skins">
                            ...
                            <div class="row">
                                <div class="col-md-9 col-sm-12">
                                    <div class="news-detail"><img src="assets/images/news-detail-1.jpg" alt="" class="news-image"/>
                                        ...
                                        <h1 class="title-news">This is heading for your blog post</h1>
                                        ...
                                        <div class="news-author">
                                            <div class="media">
                                                <div class="media-left"><a href="#" class="media-image"><img src="assets/images/people-avatar-6.png" alt="" class="author-image"/></a></div>
                                        ...
                                        <div class="news-comment">
                                            ...
                                            <ul class="comment-list list-unstyled">
                                                <li class="media">
                                                    ...
                                                    <div class="comment-box media merge-1">
                                                        <div class="list-item">
                                                            <div class="media-body">
                                                ...
                                                <li class="media">
                                                    ...
                                                    <div class="comment-box media merge-2">
                                                        <div class="list-item">
                                                            <div class="media-body">
                                                                <form action="#" class="bg-w-form comment-form">
                                                                    <div class="form-group"><textarea placeholder="Your comment here..." class="form-control form-input"></textarea></div>
                                                ...
                                                <li class="media">
                                                    ...
                                                    <div class="comment-box media merge-3">
                                                        <div class="list-item">
                                                            <div class="media-body">
                                                                <form action="#" class="bg-w-form comment-form">
                                                                    <div class="form-group"><textarea placeholder="Your comment here..." class="form-control form-input"></textarea></div>
                                    ...
                                    <div class="row">
                                        <div class="recent-post-widget widget col-sm-6 col-md-12 col-xs-6 sd380">
                                            ...
                                            <div class="content-widget">
                                                <div class="media">
                                                    <div class="media-left"><a href="courses-detail.html" class="link"><img src="assets/images/recent-post/recent-post-1.jpg" alt="" class="media-image"/></a></div>
...
<!-- Mirrored from swlabs.co/edugate/news-detail.html by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 14 Feb 2016 04:08:17 GMT -->
</html> 